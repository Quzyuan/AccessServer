 ...
 */
package com.example.accessserver.receiver;
...
import com.example.accessserver.activity.MainActivity;
import com.example.accessserver.service.ServerService;

public class ServerReceiver extends BroadcastReceiver {

    private static final String ACTION = "server_receiver";
    ...
    public ServerReceiver(MainActivity activity) {
        this.mActivity = activity;
        mService = new Intent(activity, ServerService.class);
    }
